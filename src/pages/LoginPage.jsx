...
function InputField({ label, error, rightLabel, rightHref, ...props }) {
  ...
  return (
    <div className="mb-5">
      <div className="flex justify-between items-center mb-2">
        ...
        {rightLabel && (
          <a href={rightHref || '#'} className="text-[11px] text-brown hover:underline">
            {rightLabel}
          </a>
        )}
      </div>
    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center bg-yoba-gray px-8 py-12 lg:px-20">
        ...
        >
          ...
          <p className="text-sm font-light text-yoba-gray-dark mb-8">
            Connectez-vous à votre compte Yobaleema
          </p>
